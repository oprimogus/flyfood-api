...
type PersonalizedValidation struct {
	ValidationFn           func(fl validator.FieldLevel) bool
	RegisterTranslationsFn func(ut ut.Translator) error
	TranslationFn          func(ut ut.Translator, fe validator.FieldError) string
}

func NewPersonalizedValidation(tag, errMessage string,
	validationFn func(fl validator.FieldLevel) bool) PersonalizedValidation {
	return PersonalizedValidation{
...
var personalizedValidations = map[string]PersonalizedValidation{
	"cpf":     NewPersonalizedValidation("cpf", "CPF inválido", IsValidCpf),
	"cnpj":    NewPersonalizedValidation("cnpj", "CNPJ inválido", IsValidCnpj),
	"cpfCnpj": NewPersonalizedValidation("cpfCnpj", "CPF/CNPJ inválido", IsValidCpfOrCnpj),
	"phone":   NewPersonalizedValidation("phone", "número de telefone inválido", IsValidPhone),
	"week":    NewPersonalizedValidation("week", "dia de semana inválido", isValidWeekDay),
}
