...
//			TraceID: "123",
//			want: New("123", http.StatusConflict, DuplicatedRecord, FieldError{
//				Field:   "email",
//				Input:   "test@test.com",
...
//			TraceID: "123",
//			want: New("123", http.StatusBadRequest, InvalidValues, FieldError{
...
//			TraceID:     "123",
//			want:        New("123", http.StatusInternalServerError, TooManyValues),
//			environment: string(config.Production),
//		},
//	}
//
