...
func newHealthHandler(db *database.Postgres) healthController {
...
func (h *healthController) readinessProbe(w http.ResponseWriter, r *http.Request) {
	if err := h.db.Ping(r.Context()); err != nil {
		...
		api.JSONResponse(w, http.StatusServiceUnavailable, response)
		return
	}
...
func SetupHealthRoutes(r chi.Router, db *database.Postgres) {
