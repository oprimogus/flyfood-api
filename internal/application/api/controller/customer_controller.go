...
// @Accept      json
// @Produce     json
// @Param       request body     customer.CreateProfileDTO true "Detailed customer registration information"
// @Success     201 {object}     nil "Customer successfully created"
...
func (c customerController) createCustomer(w http.ResponseWriter, r *http.Request) {
	var params customer.CreateProfileDTO
	...
	err = c.customerService.CreateCustomer(r.Context(), params)
	if err != nil {
		HandleError(w, r, err)
		return
	}
...
func (c customerController) updateCustomerProfile(w http.ResponseWriter, r *http.Request) {
	userID := "" // TODO: Extract from authentication context
