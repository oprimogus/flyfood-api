...
// 	"github.com/oprimogus/flyfood-api/internal/infra/database/persistence"
...
// 	"github.com/oprimogus/flyfood-api/internal/validator"
...
// 	err = c.command.NewProduct(r.Context(), authCtx.UserID(), params)
// 	if err != nil {
// 		core.HandleApiError(w, r, err)
// 		return
// 	}
...
// 	err = c.command.IncreaseProductStock(r.Context(), authCtx.UserID(), params)
// 	if err != nil {
// 		core.HandleApiError(w, r, err)
// 		return
// 	}
...
// 	err = c.command.DecreaseProductStock(r.Context(), authCtx.UserID(), params)
// 	if err != nil {
// 		core.HandleApiError(w, r, err)
// 		return
// 	}
